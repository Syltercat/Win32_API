// tool2.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//
...
// 메인 윈도우 외에 일반 윈도우에 관한 winproc 코드
    ...
    _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TOOL2, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TOOL2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDC_TOOL2));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_TOOL2);
    wcex.lpszClassName = szWindowClass;
    wcex.hIconSm = LoadIcon(wcex.hInstance, MAKEINTRESOURCE(IDI_SMALL));

    RegisterClassExW(&wcex);

    // 메인 윈도우에서 설정을 변경한 일반 윈도우
